...
<div class="layout overflow-hidden">
    ...
    <nav class="navigation d-flex flex-column text-center navbar navbar-light hide-scrollbar">
        <!-- Brand -->
        <a href="{{ url("index.html") }}" title="Messenger" class="d-none d-xl-block mb-6">
        ...
        <ul class="d-flex nav navbar-nav flex-row flex-xl-column flex-grow-1 justify-content-between justify-content-xl-center align-items-center w-100 py-4 py-lg-2 px-lg-3"
            ...
            <li class="nav-item d-none d-xl-block invisible flex-xl-grow-1">
                <a class="nav-link py-0 py-lg-8" href="{{ url("#") }}" title="">
            ...
            <!-- New chat -->
            <li class="nav-item">
                <a class="nav-link py-0 py-lg-8" id="tab-create-chat" href="{{ url("#tab-content-create-chat") }}"
            ...
            <!-- Friends -->
            <li class="nav-item">
                <a class="nav-link py-0 py-lg-8" id="tab-friends" href="{{ url("#tab-content-friends") }}"
                   title="Friends"
            ...
            <!-- Chats -->
            <li class="nav-item">
                <a class="nav-link active py-0 py-lg-8" id="tab-chats" href="{{ url("#tab-content-chats") }}"
                   title="Chats"
                   data-bs-toggle="tab" role="tab">
            ...
            <!-- Notification -->
            <li class="nav-item">
                <a class="nav-link py-0 py-lg-8" id="tab-notifications" href="{{ url("#tab-content-notifications") }}"
            ...
            <li class="nav-item d-none d-xl-block flex-xl-grow-1">
                <a class="nav-link py-0 py-lg-8" id="tab-support" href="{{ url("#tab-content-support") }}"
                   title="Support"
                   data-bs-toggle="tab" role="tab">
                    <div class="icon icon-xl">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
            ...
            <li class="nav-item d-none d-xl-block">
                <a class="nav-link py-0 py-lg-8" id="tab-settings" href="{{ url("#tab-content-settings") }}"
                   title="Settings"
                   data-bs-toggle="tab" role="tab">
                    <div class="icon icon-xl">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
            ...
            <!-- Profile -->
            <li class="nav-item">
                <a href="{{ url("#") }}" class="nav-link p-0 mt-lg-2" data-bs-toggle="modal"
                                ...
                                <ul class="nav nav-pills nav-justified" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="pill"
                                           href="{{ url("#create-chat-members") }}" role="tab"
                            ...
                            <div class="card-list">
                                ...
                                <div class="card border-0">
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center gx-5">
                                            ...
                                            <div class="col">
                                                <h5><a href="{{ url("#") }}">Bill Marrow</a></h5>
                                                <p>last seen 3 days ago</p>
                                            </div>
                                            ...
                                            <div class="col-auto">
                                                <!-- Dropdown -->
                                                <div class="dropdown">
                                                    <a class="icon text-muted" href="{{ url("#") }}" role="button"
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item" href="{{ url("#") }}">New
                                                                message</a></li>
                                                        <li><a class="dropdown-item" href="{{ url("#") }}">Edit
                                                                contact</a>
                                                        </li>
                                                        <li>
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item text-danger" href="{{ url("#") }}">Block
                                                                user</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                        ...
                                        <div class="row align-items-center gx-5">
                                            <div class="col-auto">
                                                <a href="{{ url("#") }}" class="avatar ">
                                                    ...
                                                    <img class="avatar-img"
                                                         src="{{ asset("/assets/img/avatars/5.jpg") }}" alt="">
                                            ...
                                            <div class="col">
                                                <h5><a href="{{ url("#") }}">Damian Binder</a></h5>
                                                <p>last seen within a week</p>
                                            </div>
                                ...
                                <div class="card border-0">
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center gx-5">
                                            <div class="col-auto">
                                                <a href="{{ url("#") }}" class="avatar avatar-online">
                                        ...
                                        <div class="row align-items-center gx-5">
                                            <div class="col-auto">
                                                <a href="{{ url("#") }}" class="avatar avatar-online">
                                                    ...
                                                    <img class="avatar-img"
                                                         src="{{ asset("/assets/img/avatars/8.jpg") }}" alt="">
                                            ...
                                            <div class="col">
                                                <h5><a href="{{ url("#") }}">Elise Dennis</a></h5>
                                                <p>online</p>
                                            </div>
                                ...
                                <div class="card border-0">
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center gx-5">
                                            ...
                                            <div class="col">
                                                <h5><a href="{{ url("#") }}">Marshall Wallaker</a></h5>
                                                <p>last seen within a month</p>
                                            </div>
                                ...
                                <div class="card border-0">
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center gx-5">
                                            ...
                                            <div class="col">
                                                <h5><a href="{{ url("#") }}">Ollie Chandler</a></h5>
                                                <p>online</p>
                                            </div>
                                        ...
                                        <div class="row align-items-center gx-5">
                                            <div class="col-auto">
                                                <a href="{{ url("#") }}" class="avatar ">
                                                    ...
                                                    <img class="avatar-img"
                                                         src="{{ asset("/assets/img/avatars/4.jpg") }}" alt="">
                                            ...
                                            <div class="col">
                                                <h5><a href="{{ url("#") }}">Warren White</a></h5>
                                                <p>last seen recently</p>
                                            </div>
                                ...
                                <div class="card border-0">
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center gx-5">
                                            ...
                                            <div class="col">
                                                <h5><a href="{{ url("#") }}">William Wright</a></h5>
                                                <p>online</p>
                                            </div>
                ...
                <div class="d-flex flex-column h-100 position-relative">
                    <div class="hide-scrollbar">
                        ...
                        <div class="container py-8">
                            ...
                            <div class="card-list">
                                <!-- Card -->
                                <a href="{{ url("chat-group.html") }}" class="card border-0 text-reset">
                                    <div class="card-body">
                                        <div class="row gx-5">
                                            <div class="col-auto">
                                                <div class="avatar avatar-online">
                                ...
                                <!-- Card -->
                                <a href="{{ url("chat-direct.html") }}" class="card border-0 text-reset">
                                    <div class="card-body">
                                        <div class="row gx-5">
                                            <div class="col-auto">
                                                <div class="avatar avatar-online">
                                ...
                                <!-- Card -->
                                <a href="{{ url("chat-empty.html") }}" class="card border-0 text-reset">
                                    <div class="card-body">
                                        <div class="row gx-5">
                                            <div class="col-auto">
                                                <div class="avatar avatar-online">
                                ...
                                <!-- Card -->
                                <a href="{{ url("#") }}" class="card border-0 text-reset">
                                    <div class="card-body">
                                        <div class="row gx-5">
                                            <div class="col-auto">
                                                <div class="avatar avatar-online">
                        ...
                        <div class="container py-8">
                            ...
                            <div class="card-list">
                                ...
                                <div class="d-flex align-items-center my-4 px-6">
                                    ...
                                    <a href="{{ url("#") }}" class="text-muted small">Clear all</a>
                                </div>
                                <!-- Title -->
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="dropdown ms-5">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a class="dropdown-item" href="{{ url("#") }}">Show less
                                                                    often</a>
                                                            </li>
                                                            <li><a class="dropdown-item" href="{{ url("#") }}">Hide</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row gx-5">
                                            ...
                                            <div class="col">
                                                <div class="d-flex align-items-center mb-2">
                                                    <h5 class="me-auto mb-0">
                                                        <a href="{{ url("#") }}">Don Knight</a>
                                                    </h5>
                                                    <span class="extra-small text-muted ms-2">08:45 PM</span>
                                                </div>

                                                <div class="d-flex">
                                                    <!-- <div class="me-auto">Removed you from the chat <a href="{{ url("#") }}" class="text-reset">Bootstrap Community</a>.</div> -->
                                ...
                                <div class="card border-0">
                                    <div class="card-body">
                                        ...
                                        <div class="row gx-5">
                                            <div class="col-auto">
                                                <!-- Avatar -->
                                                <a href="{{ url("#tab-settings") }}" class="avatar avatar-badged"
                                            ...
                                            <div class="col">
                                                <div class="d-flex align-items-center mb-2">
                                                    <h5 class="me-auto mb-0">
                                                        <a href="{{ url("#tab-settings") }}" data-theme-toggle="tab">
                                                            Notifications
                                                        </a>
                                                    </h5>
                                                    <span class="extra-small text-muted ms-2">08:45 PM</span>
                                ...
                                <div class="card border-0">
                                    <div class="card-body">
                                        <div class="row align-items-center gx-0">
                                            ...
                                            <div class="col-auto">
                                                <a href="{{ url("password-reset.html") }}"
                                                   class="btn btn-sm btn-icon btn-primary rounded-circle">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                         viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                         stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="container py-8">
                            ...
                            <div class="mt-8">
                                <div class="d-flex align-items-center my-4 px-6">
                                    ...
                                    <div class="flex align-items-center text-muted">
                                        <a href="{{ url("#") }}" class="text-muted small">Clear storage</a>
                            ...
                            <div class="mt-8">
                                <div class="d-flex align-items-center my-4 px-6">
                                    ...
                                    <div class="flex align-items-center text-muted">
                                        <a href="{{ url("#") }}" class="text-muted small">End all sessions</a>
            ...
            <div class="d-flex flex-column h-100 position-relative">
                ...
                <div class="chat-header border-bottom py-4 py-lg-7">
                    <div class="row align-items-center">
                        ...
                        <div class="col-2 d-xl-none">
                            <a class="icon icon-lg text-muted" href="{{ url("#") }}" data-toggle-chat="">
                            ...
                            <div class="row align-items-center text-center text-xl-start">
                                ...
                                <div class="col-xl-6 d-none d-xl-block">
                                    <div class="row align-items-center justify-content-end gx-6">
                                        <div class="col-auto">
                                            <a href="{{ url("#") }}" class="icon icon-lg text-muted"
                                        ...
                                        <div class="col-auto">
                                            <div class="avatar-group">
                                                <a href="{{ url("#") }}" class="avatar avatar-sm" data-bs-toggle="modal"
                        ...
                        <div class="col-2 d-xl-none text-end">
                            <a href="{{ url("#") }}" class="icon icon-lg text-muted" data-bs-toggle="offcanvas"
                               data-bs-target="#offcanvas-more" aria-controls="offcanvas-more">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <div class="chat-body hide-scrollbar flex-1 h-100">
                    <div class="chat-body-inner">
                        <div class="py-6 py-lg-12">
                            ...
                            <!-- Message -->
                            <div class="message">
                                <a href="{{ url("#") }}" data-bs-toggle="modal" data-bs-target="#modal-user-profile"
                            ...
                            <div class="message message-out">
                                <a href="{{ url("#") }}" data-bs-toggle="modal" data-bs-target="#modal-profile"
                                   class="avatar avatar-responsive">
                                    <img class="avatar-img" src="{{ asset("/assets/img/avatars/1.jpg") }}" alt="">
                                </a>
                                                ...
                                                <div class="row align-items-center gx-4">
                                                    ...
                                                    <div class="col overflow-hidden">
                                                        <h6 class="text-truncate text-reset">
                                                            <a href="{{ url("#") }}"
                                                               class="text-reset">filename.json</a>
                                                        </h6>
                                                ...
                                                <div class="row gx-3">
                                                    <div class="col">
                                                        <img class="img-fluid rounded"
                                                             src="{{ asset("/assets/img/chat/1.jpg") }}"
                                                             data-action="zoom" alt="">
                                                    </div>
                                                    <div class="col">
                                                        <img class="img-fluid rounded"
                                                             src="{{ asset("/assets/img/chat/2.jpg") }}"
                                                             data-action="zoom" alt="">
                                                    </div>
                                                    <div class="col">
                                                        <img class="img-fluid rounded"
                                                             src="{{ asset("/assets/img/chat/3.jpg") }}"
                                                             data-action="zoom" alt="">
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="chat-footer pb-3 pb-lg-7 position-absolute bottom-0 start-0">
                    ...
                    <form class="chat-form rounded-pill bg-dark" data-emoji-form="">
                        <div class="row align-items-center gx-0">
                            <div class="col-auto">
                                <a href="{{ url("#") }}" class="btn btn-icon btn-link text-body rounded-circle"
                                   id="dz-btn">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                         fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            ...
                            <div class="col">
                                <div class="input-group">
                                    ...
                                    <a href="{{ url("#") }}" class="input-group-text text-body pe-0" data-emoji-btn="">
    ...
    <div class="offcanvas offcanvas-end offcanvas-aside" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1"
        ...
        <div class="offcanvas-header py-4 py-lg-7 border-bottom">
            <a class="icon icon-lg text-muted" href="{{ url("#") }}" data-bs-dismiss="offcanvas">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                     stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <!-- Dropdown -->
            <div class="dropdown">
                <a class="icon icon-lg text-muted" href="{{ url("#") }}" role="button" data-bs-toggle="dropdown"
                   aria-expanded="false">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                         stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                         class="feather feather-more-vertical">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <a href="{{ url("#") }}" class="dropdown-item d-flex align-items-center text-danger">
                            Leave
                            <div class="icon ms-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
        ...
        <div class="offcanvas-body hide-scrollbar">
            ...
            <ul class="nav nav-pills nav-justified" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-bs-toggle="pill" href="{{ url("#offcanvas-tab-profile") }}"
                       role="tab"
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="pill" href="{{ url("#offcanvas-tab-media") }}" role="tab"
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="pill" href="{{ url("#offcanvas-tab-files") }}" role="tab"
            ...
            <div class="tab-content py-2" role="tablist">
                ...
                <div class="tab-pane fade show active" id="offcanvas-tab-profile" role="tabpanel">
                    ...
                    <ul class="list-group list-group-flush border-top mt-8">
                        <li class="list-group-item">
                            <a href="{{ url("#") }}" class="text-reset">Send Message</a>
                        </li>

                        <li class="list-group-item">
                            <a href="{{ url("#") }}" class="text-danger">Delete Chat</a>
                        </li>
                    </ul>
                </div>
                <!-- Profile -->
                ...
                <div class="tab-pane fade" id="offcanvas-tab-media" role="tabpanel">
                    <div class="row row-cols-3 g-3 py-6">
                        <div class="col">
                            <a href="{{ url("#") }}" data-bs-toggle="modal" data-bs-target="#modal-media-preview"
                            ...
                            <div class="row align-items-center gx-5">
                                ...
                                <div class="col overflow-hidden">
                                    <h5 class="text-truncate">
                                        <a href="{{ url("#") }}">E5419783-047D-4B4C-B30E-F24DD8247731.JPG</a>
                                    </h5>
    ...
    <div class="modal-dialog modal-dialog-centered modal-fullscreen-xl-down">
        <div class="modal-content">
            ...
            <div class="modal-body py-0">
                ...
                <!-- Button -->
                <div class="modal-py">
                    <a href="{{ url("#") }}" class="btn btn-lg btn-primary w-100 d-flex align-items-center"
    ...
    <div class="modal-dialog modal-dialog-centered modal-fullscreen-xl-down">
        <div class="modal-content">
            ...
            <div class="modal-body py-0">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">
                        <a href="{{ url("#tab-settings") }}" class="text-reset" data-theme-toggle="tab" title="Settings"
                           data-bs-dismiss="modal">Settings</a>
                    </li>

                    <li class="list-group-item">
                        <a href="{{ url("#") }}" class="text-danger">Logout</a>
                    </li>
                </ul>
                <!-- List -->
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body py-0">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        <a href="{{ url("#") }}" class="text-danger">Block User</a>
                    </li>
                </ul>
                <!-- List -->
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <div>
                    <!-- Dropdown -->
                    <div class="dropdown">
                        <a class="icon text-muted" href="{{ url("#") }}" role="button" data-bs-toggle="dropdown"
                           aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                 fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                 stroke-linejoin="round" class="feather feather-more-vertical">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center text-danger" href="{{ url("#") }}">
                                    <span class="me-auto">Delete</span>
                                    <div class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                             viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
            ...
            <div class="modal-body p-0">
                <div class="d-flex align-items-center justify-content-center h-100">
                    <img class="img-fluid modal-preview-url" src="{{ asset("/#") }}" alt="#">
                </div>
            </div>
            <!-- Modal: Body -->
            ...
            <div class="modal-footer">
                <div class="w-100 text-center">
                    <h6><a href="{{ url("#") }}">Marshall Wallaker</a></h6>
